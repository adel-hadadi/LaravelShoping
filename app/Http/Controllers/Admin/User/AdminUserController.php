...
class AdminUserController extends Controller
{
    ...
    public function store(AdminUserRequest $request, ImageService $imageService)
    {
        ...
        if ($request->hasFile('profile_photo_path')) {
            ...
            if ($result == false) {
                return redirect()->route('admin.user.admin-user.index')->with('swal-error', 'آپلود تصویر با خطا مواجخ شد');
            }
    ...
    public function update(AdminUserRequest $request, User $user, ImageService $imageService)
    {
        ...
        return redirect()->route('admin.user.admin-user.index')->with('swal-success', 'ادمین مورد نظر با موفقیت ویرایش شد');
    }
    ...
    public function destroy(User $user)
    {
        ...
        return redirect()->route('admin.user.admin-user.index')->with('swal-error', 'ادمین مورد نظر با موفقیت حذف شد');
    }
