...
class MenuController extends Controller
{
    ...
    public function store(MenuRequest $request)
    {
        ...
        return redirect()->route('admin.content.menu.index')->with('swal_success', 'منو جدید شما با موفقیت ثبت شد');
    }
    ...
    {
        $result = $menu->delete();
        return redirect()->route('admin.content.menu.index')->with('swal-error', 'منو مورد نظر با موفقیت حذف شد');
    }
