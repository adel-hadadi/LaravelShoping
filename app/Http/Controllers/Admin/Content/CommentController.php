...
class CommentController extends Controller
{
    ...
    {
        $unSeenComments = Comment::wehere('seen', 0)->get();
    ...
    public function approved(Comment $comment)
    {
        ...
        return redirect()->route('admin.content.comment.index')->with('swal-success', 'وضعیت نظر با موفقیت تغییر کرد');
            ...
            return redirect()->route('admin.content.comment.index')->with('swal-success', 'وضعیت نظر با خطا مواجه شد');
        }
    }
    ...
    public function answer(CommentRequest $request, Comment $comment){
       if($comment->parent_id == null){
           ...
           return redirect()->route('admin.content.comment.index')->with('swal-success', 'پاسخ نظر با موفقیت ثبت شد');
       }
       else{
