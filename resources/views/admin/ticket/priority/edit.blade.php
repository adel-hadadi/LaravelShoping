    ...
    <section class="row">
        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form id="form" action="{{ route('admin.ticket.priority.update', $ticketPriority->id) }}" method="post"
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control form-control-sm">
                                        ...
                                        <option value="0" @if (old('status', $ticketPriority->status) == 0)
                                            selected
                                            @endif>غیر فعال</option>
                                        <option value="1" @if (old('status', $ticketPriority->status) == 1)
                                            selected
                                            @endif>فعال</option>
                                    </select>
                                </div>
