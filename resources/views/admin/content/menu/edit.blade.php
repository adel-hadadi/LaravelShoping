...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> ویرایش منوی</li>
        </ol>
    </nav>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent_id" id="" class="form-control form-control-sm">
                                        ...
                                        @foreach ($parent_menus as $parent_menu)
                                            <option value="{{ $parent_menu->id }}" @if (old('parent_id', $menu->parent_id) == $parent_menu->id)
                                                selected
