                ...
                <section>
                    <form action="{{ route('admin.market.product.store') }}" method="post" id="form"
                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    <label class=" form-label">وزن کالا</label>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <label class="form-label" for="marketable">قابل فروش بودن</label>
                            ...
                            <section class="col-12 border-top border-bottom py-3 mb-3">
                                ...
                                <section>
                                    <button type="button" id="btnCopy" class="btn btn-success btn-sm">افزودن</button>
                                </section>
                            </section>
                        </section>
