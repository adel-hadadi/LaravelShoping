                        ...
                        <section class="brands dark-owl-nav owl-carousel owl-theme">
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset("customer-assets/images/brand/huawei.jpg")}}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                            ...
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset("customer-assets/images/brand/logitech.jpg")}}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                            ...
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset("customer-assets/images/brand/pakshoma.png")}}"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset("customer-assets/images/brand/panasonic.png"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset("customer-assets/images/brand/parskhazar.png"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset("customer-assets/images/brand/samsung.png"
                                            alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                            ...
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset("customer-assets/images/brand/xvision.png"
                                            alt=""></a>
                                </section>
                            </section>
                        </section>
